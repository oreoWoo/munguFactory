...
function changePw()
{	
	var emp_no		   = $('#result_emp_no').val();
	var emp_password 	   = $('#password').val();
	var emp_password_chk = $('#password_chk').val();
	...
	if (emp_password == emp_password_chk)
	{
		$.ajax({
	...
	else if (emp_password != emp_password_chk)
	{
	          		...
	          		<div class="p-5">
						...
						<div class="tab-content">
							<div id="menu1" class="container tab-pane active"><br>
								...
								<!-- 사번 -->
								<div class="form-group textbox">
									<label for="emp_no1">사번</label>
									<input type="text" class="form-control" id="emp_no1" name="emp_no">
								</div>
							...
							<div id="menu2" class="container tab-pane active"><br>
								...
								<div class="form-group textbox">
									<label for="emp_no1">사번</label>
									<input type="text" class="form-control" id="emp_no2" name="emp_no">
								</div>
