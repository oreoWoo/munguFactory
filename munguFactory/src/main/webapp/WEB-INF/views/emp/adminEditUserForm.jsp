...
<body>
	...
	<h4 class="fw-bold py-3 mb-4">관리자용 사원 마이페이지</h4>
	<div class="card mb-6">
		...
		<form action="/admin/adminEditUserInfo" method="post">
			<table class="table" style="width: 1300px; margin-left:50px;  margin-top: 50px; margin-bottom: 50px;">
				...
				<tr>
					...
					<td> 
						<c:choose>
							<c:when test="${userEmp.emp_gender eq '남자'}">
				...
				<tr>
					...
					<select name="email" class="form-select" id="domain_list" onclick="changeDomain()" style="display: inline;">
